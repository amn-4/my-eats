        ...
        <>
            ...
            <FormControl sx={{ minWidth: 200 }}>
                ...
                >
                    ...
                    {suburbs.map(suburb => (
                        <MenuItem key={suburb.id} value={suburb.id}>{suburb.name}</MenuItem>
                    ))}
                </Select>
            </FormControl>
            ...
            <FormControl sx={{ minWidth: 200 }}>
                ...
                >
                    ...
                    {cuisines.map(cuisines => (
                        <MenuItem key={cuisines.id} value={cuisines.id}>{cuisines.name}</MenuItem>
                    ))}
                </Select>
            </FormControl>
            ...
            <FormControl sx={{ minWidth: 200 }}>
                ...
                >
                    ...
                    {dietaryReqs.map(dietaryReqs => (
                        <MenuItem key={dietaryReqs.id} value={dietaryReqs.id}>{dietaryReqs.name}</MenuItem>
                    ))}
                </Select>
            </FormControl>
            ...
            <FormControl sx={{ minWidth: 200 }}>
                ...
                >
                    ...
                    {tags.map(tags => (
                        <MenuItem key={tags.id} value={tags.id}>{tags.name}</MenuItem>
                    ))}
                </Select>
            </FormControl>
